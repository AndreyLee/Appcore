...
<body>
    <header class="admin-header">
        ...
        <nav>
            ...
            <?php endif; ?>
            <a href="alterar_senha.php" class="active">Alterar Senha</a>
    ...
    <main class="admin-main">
        ...
        <?php elseif (!isset($_SESSION['admin_user_id']) && isset($_SESSION['admin_logged_in'])): ?>
            <p class="mensagem info">Esta funcionalidade requer que o sistema de login via banco de dados esteja ativo. Atualmente, você está logado com o sistema legado.</p>
        <?php endif; ?>
    </main>
    <footer>
